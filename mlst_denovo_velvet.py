...
# mlst_denovo_velvet.py --short fastq.gz interleaved.fastq.gz --ksizes 33 --outpath test --add_velvetg "-very_clean yes"

start_assembly(args, 'mlst_wrapper_denovo.log')
